...
const ScrollableTabBar = createReactClass({
  propTypes: {
    ...
    style: ViewPropTypes != undefined && ViewPropTypes.style,
    tabStyle: ViewPropTypes != undefined && ViewPropTypes.style,
    tabsContainerStyle: ViewPropTypes != undefined && ViewPropTypes.style,
    renderTab: PropTypes.func,
    underlineStyle: ViewPropTypes != undefined && ViewPropTypes.style,
