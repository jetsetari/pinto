...
function CartScreen(props) {
  ...
  return (
    <HeaderContainer headerVisible={false} title="Cart" back={"Home"} navigation={props.navigation}>
      <View style={[ styles.container, {marginTop: 0} ] }>
            ...
            <View key={ key } style={ styles.item }>
              <View style={ styles.itemcontent }>
                ...
                <View style={ styles.textWrap }>
                  <Text style={ styles.productTitle }>{product?.title.split(/–|-/, 2)[lang_i].trim()}</Text>
        ...
        <TouchableOpacity style={[globalStyles.mainButton, {marginTop: 20, marginBottom: 0, width: '100%'}]} onPress={() => purchase(products)}>
            <Text style={globalStyles.mainButtonText}>{i18n.t('proceed_to_location')}</Text>
        </TouchableOpacity>
      </View>
    </HeaderContainer>
  );
